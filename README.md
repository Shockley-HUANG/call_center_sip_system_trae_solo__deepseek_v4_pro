...
基于 **C/C++ + Lua + SIP + RTP + epoll** 技术栈的企业级呼叫中心模拟系统，支持1000人规模企业内部通信、外部400总机IVR导航、24小时人工客服。
...
程序将自动加载 `lua/route.lua` 路由脚本，运行13个呼叫路由测试用例 + 6个内部互拨测试，输出路由结果。
...
| 时间 | 版本 | 内容 |
|------|------|------|
| 2026-05-18 20:30 | v0.1.0 | 初始化呼叫中心C+Lua项目基础框架，完成Demo编译运行；版本管控体系建立，GitHub公开仓库创建，远程仓库重命名 |